...
prabel_image = face_recognition.load_image_file("faces/prabel.jpg")
prabel_encoding = face_recognition.face_encodings(prabel_image)[0]


known_face_encoding = [adarsh_encoding, prabel_encoding]
known_face_name = ["adarsh", "prabel"]
